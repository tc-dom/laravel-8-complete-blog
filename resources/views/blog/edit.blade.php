    ...
    <form action="/blog/{{$post->slug}}" method="POST" enctype="multipart/form-data">
        ...
        <nav class="navbar mb-5 navbar-expand-lg navbar-light bg-light border">
            <div class="container-fluid">
              <a class="navbar-brand" href="#">กำลังแก้ไข</a>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="title" value="{{$post->title}}" type="text" class="form-control form-control-lg" id="exampleFormControlInput1" placeholder="Type any text...">
                </div>
                <div class="form-group mt-3">
                    ...
                    <select multiple name="category_id[]" id="category_id" class="form-control" id="exampleFormControlSelect2">
                        ...
                        <option value="{{ $category->id }}" {{ in_array($category->id, explode(',', $post->category_id)) ? 'selected' : '' }}>
                            {{ $category->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group mt-3">
                    ...
                    <input name="slug" value="{{$post->slug}}" type="text" class="form-control form-control-lg" id="exampleFormControlInput1" placeholder="ภาษาอังกฤษเท่านั้น">
                </div>
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="body" class="form-control" rows="8">
...
<script>
    tinymce.init({
        ...
        images_upload_url: '/manage/image/upload',
        ...
        images_upload_handler: function(blobInfo, success, failure) {
            ...
            xhr.open('POST', '/manage/image/upload');
